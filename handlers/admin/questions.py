...
from keyboards.default.markups import questions, questions_adm
from aiogram.dispatcher import FSMContext
from aiogram.utils.callback_data import CallbackData

from keyboards.default.cb import question_cb
...
@dp.message_handler(IsAdmin(), text=questions_adm)
async def process_questions(message: Message):
    ...
    if len(questions) == 0:
        ...
        for cid, question in questions:
            ...
            await message.answer(f"Пользователь: {cid}\n"
                                 f"Вопрос: {question}", parse_mode=types.ParseMode.MARKDOWN, reply_markup=markup)
